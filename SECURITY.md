...
Eğer projenin kendisinde (kod, Dockerfile, script'ler) bir güvenlik açığı bulursanız, e-posta gönderin (repo sahibinin GitHub profilindeki iletişim bilgilerine bakın).
