...
.PHONY: setup start stop build clean capture status help modules test open logs shell update restart check shark-tank test-sharktank
...
modules: ## Modül listesini göster
	...
	@echo "  17  - Kerberos Analizi    module-17-kerberos/module-17-kerberos.md"
	@echo "  18  - LDAP Analizi        module-18-ldap/module-18-ldap.md"
	@echo "  19  - SMB2 Analizi        module-19-smb2/module-19-smb2.md"
	@echo "  20  - tshark CLI          module-20-tshark/module-20-tshark.md"
	@echo "  21  - Gelişmiş Capture    module-21-advanced-capture/module-21-advanced-capture.md"
	@echo "  22  - TCP Grafikleri      module-22-tcp-graph/module-22-tcp-graph.md"
	@echo "  23  - Performans Analizi  module-23-performance/module-23-performance.md"
	@echo "  24  - WLAN (802.11)       module-24-wlan/module-24-wlan.md"
	@echo "  25  - VoIP (SIP/RTP)      module-25-voip/module-25-voip.md"
	@echo "  26  - Baseline Analizi    module-26-baseline/module-26-baseline.md"
	@echo "  27  - Sınav Pratiği       module-27-exam-practice/module-27-exam-practice.md"
	@echo "  28  - Ağ Forensics        module-28-forensics/module-28-forensics.md"
...
shark-tank: ## Tüm pcap'ler için bulgu raporu üret (shared/pcaps/*.md)
	@chmod +x scripts/shark-tank.sh
	./scripts/shark-tank.sh $(FILE)

test-sharktank: ## Shark-Tank analiz aracı regresyon testi
	@chmod +x scripts/shark-tank-test.sh
	./scripts/shark-tank-test.sh
